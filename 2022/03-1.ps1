...
function Invoke-Part1($textinput) {
    ...
    |ForEach-Object {
        $_ | Add-Member -MemberType NoteProperty -Name "ErrorItem" -Value (
            Compare-Object `
                -IncludeEqual `
                -ReferenceObject $_.Comp1 `
                -DifferenceObject $_.Comp2
    ...
    |ForEach-Object {
        $_ | Add-Member -MemberType NoteProperty -Name "PriorityScore" -Value (
            $priorityTable[$_.ErrorItem]
        )
        $_
    }
    | Measure-Object -Property PriorityScore -Sum
}
